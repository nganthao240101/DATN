...
while True:
    ...
    """
    check_data=execute_query(db_path,sql_select)
 
    directory_path = "/home/ubuntu/Desktop/aipcap/TCPDUMP_and_CICFlowMeter/csv"
    latest_file = get_latest_file(directory_path, "csv")
    if latest_file is None:
        print("Không tìm thấy file mới, đợi 60 giây...")
        time.sleep(60)
        continue
